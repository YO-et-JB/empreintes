  ...
  return (
    <Page title="Politique de confidentialité" small>
      <article className="prose w-auto max-w-7xl flex-auto cursor-default">
        <p>
          <strong>L’association Association LIBrE </strong>, soucieuse des
          ...
          droits. Pour toute information complémentaire sur la protection des
        ...
        <p>
          <strong>
            L’association LIBrE ,déclarée auprès de la préfecture de NANCY
          </strong>
          sous le numéro
          <strong>
            {" "}
            519 354 096 00017 dont le siège social est situé : 77 Av Carnot
            54130.
          </strong>
          <br />
        ...
        <strong>
          EmpreintesetDigitaleseditions.com est hébergé par OVH , dont le siège
          social est situé 19 Pl. Françoise Dorin Paris .
        </strong>
        ...
        <p>
          ...
          l’éditeur, sont strictement interdites. Le fait pour l’éditeur de ne
          pas engager de procédure dès la prise de connaissance de ces
        ...
        <p>
          ...
          virales par Internet. Vous êtes par ailleurs seul responsable des
          sites et données que vous consultez.
        </p>
        <p>
        ...
        <p>Vos données sont collectées par l’association Association LIBrE .</p>
        <p>
        ...
        <h2>Article 10 – Politique de conservation des données</h2>La Plateforme
        conserve vos données pour la durée nécessaire pour vous fournir ses
        services ou son assistance. Dans la mesure raisonnablement nécessaire ou
        requise pour satisfaire aux obligations légales ou réglementaires,
        régler des litiges, empêcher les fraudes et abus ou appliquer nos
        modalités et conditions, nous pouvons également conserver certaines de
        vos informations si nécessaire, même après que vous ayez fermé votre
        ...
        <strong>lesyeuxrouges@free.fr</strong>
        <p>
        ...
        <p>
          ...
          décline toute responsabilité à cet égard. Les données sont conservées
          et utilisées pour une durée conforme à la législation en vigueur.
        </p>
        ...
        <p>
          ...
          utilisé (source :
          <strong>
            <Link href="https://www.cnil.fr/fr/cookies-et-autres-traceurs/regles/cookies/que-dit-la-loi">
        ...
        <strong>Les cookies suivants sont présents sur ce site :</strong>
        <p>placeholder</p>
...
PrivacyPolicyPage.isPublic = true
